...
**"Math magicians" project** is a website for all fans of mathematics. It is a Single Page App (SPA) that allows users to:
...
- [Live Demo Link. Click here!](https://math-magician-bsoj.onrender.com/)
...
Feel free to check the [issues page](https://github.com/Fombi-Favour/math-magicians/issues).
...
## 🙏 Acknowledgments <a name="acknowledgements"></a>
  ...
  I would like to thank everybody most especially the Microverse staffs for making it possible to work on the "Math magicians" project.
